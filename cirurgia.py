                ...
                if ((Salas[s].especialidade == -1 or Salas[
                    ...
                    for cirurgiao in Cirurgioes:
                        if (
                            ...
                            print("Cirurgiao :{} no dia {} usou {} ".format(
                                cirurgiao.id, dia, cirurgia.tc))
    ...
    while (it != max_iter):
        ...
        for ant in Ants:
            ...
            while (visited_cnt != max_nodes):
                ...
                print(
                    " Tentou ir do vertice: {} com a operacao: {} para o vértice {}".format(
                        v.value, G.getEdge(Ni[idx])[1], estado_escolhido.value))

                if (ant.isVisited(G.nodes[estado_escolhido]) == False):
                    print("Visistou o vértice com valor {}".format(
                        estado_escolhido.value))
